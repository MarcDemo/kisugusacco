...
urlpatterns = [
    ...
    path('year-end-settlement/payout/<int:settlement_id>/', views.record_settlement_payout, name='record_settlement_payout'),
    path('forgot-password/', views.forgot_password, name='forgot_password'),
    path('verify-code/', views.verify_code, name='verify_code'),
    path('set-new-password/', views.set_new_password, name='set_new_password'),
    path('member-accounts/<int:member_id>/', views.member_accounts_api, name='member_accounts_api'),
    path('financial/<str:record_type>/<int:object_id>/edit/', views.financial_record_edit, name='financial_record_edit'),
    path('financial/<str:record_type>/<int:object_id>/history/', views.financial_record_history, name='financial_record_history'),
